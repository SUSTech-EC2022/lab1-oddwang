...
% crossoverProb = linear_ranking_selection(Scaled_fitness,0.5); 
...
% Scaled_fitness_all = exponential_fitness_scaling(-[fitness; offspring_fitness],0.5);
Scaled_fitness_all = sigma_fitness_scaling(-[fitness; offspring_fitness],1);
...
title('Arithmetic + LinearRankingSelection+sigma')
