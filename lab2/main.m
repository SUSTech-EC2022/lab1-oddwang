...
%     [offspring(2*i-1,:), offspring(2*i,:)] = Simple_Arithmetic(population(parentIndexes(1),:), population(parentIndexes(2),:), rand(1));
end
% Mutation
%% TODO
...
for i = 1:populationSize
    % mutation method
    offspring(i,:) = Guassian_Mutation(offspring(i,:), lower_bound, upper_bound, 0.001);
